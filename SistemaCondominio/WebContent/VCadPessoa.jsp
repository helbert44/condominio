						...
						<div class="hero">
							<div class="field is-grouped is-grouped-centered">			           
								<form class="form is-small"> <!-- FORM 1-->           
											...
											<div class="field">
											 <div class="control">
											 	<div class="select is-primary is-small">
												  <select  disabled name="tipoPess" id="tipoPess" value="${param.tipoPess}">
													  <option value="Proprietário">Proprietário</option>
								                      <option>Locatário</option>
								                      <option>Morardor</option>
								                      <option>Prop. e Loc</option>
	                				...
	                				<div class="columns">
		                				<div class="column">
									        <a onclick="alerta(this)" class="button is-success is-outlined"> Salvar </a>
		                				</div>
		                				<div class="column">
