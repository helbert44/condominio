	...
	<section class="hero is-small is-primary is-bold">
		...
		<div class="column">
			...
			<div class="box is-small">
				<div class="content">
					<div class="hero">
						<a class="button is-medium is-outlined is-primary" href="VCadCondo.html">Condomínio</a><br>
			...
			<p><h1 class="title">Solicitações</h1> </p>
				<div class="box is-small">
					<div class="content">
						<div class="hero">
							<div class="hero">
								<a class="button is-medium is-outlined" disabled>Manutenção/Chamados</a><br>
								<a class="button is-medium is-outlined" disabled>Mensagens</a><br>
			...
			<p><h1 class="title">Relatórios</h1></p>
				<div class="box is-small">
					<div class="content">
						<div class="hero">
							<div class="hero">
								<a class="button is-medium is-primary" href="VRelatorioPessoa.jsp">Pessoas</a><br>
...
<footer class="hero is-small">
  <div class="content has-text-centered">
    <p>Desenvolvido por <a target="_blank" href="VApresentacao.jsp">Helbert Ribeiro</a></p>
  </div>
</footer>
